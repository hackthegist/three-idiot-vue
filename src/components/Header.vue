<template>
    <header>
        <v-app-bar app clipped-right color="transparent" dense>
            ...
            <v-spacer />
            <div v-show="isStaff">
                <v-btn text color="white" to="/admin-movie-list"
                    >영화 관리</v-btn
                >
                <v-btn text color="white" to="/admin-user-list"
                    >유저 관리</v-btn
                >
            </div>
            <v-btn text color="white" to="/login" v-if="!isLogin">로그인</v-btn>
            <v-btn text color="white" @click="logout" v-if="isLogin"
                >로그아웃</v-btn
            >
            <div v-show="isLogin">
                <v-btn text color="white" to="/movie-select"
                    >내 취향 분석</v-btn
                >
                <v-btn text color="white" to="/movie-list"
                    >추천 영화 보기</v-btn
                >
