<template>
  <v-navigation-drawer :value="drawer" app absolute clipped relative right>
    <v-list dense>
...
export default {
  ...
  data() {
    return {
      items: [
        { icon: "mdi-trending_up", text: "겨울 왕국 2" },
        { icon: "subscriptions", text: "블랙 머니" },
        { icon: "history", text: "82년생 김지영" }
      ],
